...
contract HakkaCoin is StandardToken, Ownable, TokenDestructible, Migrations {
  string public constant name = "Hakka Coin";
  string public constant symbol = "HAK";

...
"Test1" : {
    ...
    "post" : {
        "mem" :  #exists("value000", 9),
        "mem" :  #exists("value001", 8),
        "mem" :  #exists("value002", 7),

        "mem" :  #exists("value010", 8),
        "mem" :  #exists("value011", 7),
        "mem" :  #exists("value012", 6),

        "mem" :  #exists("value020", 7),
        "mem" :  #exists("value021", 6),
        "mem" :  #exists("value022", 5),

        "mem" :  #exists("value030", 6),
        "mem" :  #exists("value031", 5),
        "mem" :  #exists("value032", 4),
